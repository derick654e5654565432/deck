...
export function initDb(dbPath) {
  ...
  db.exec(`
    ...
    -- Calendar: a project or to-do placed at a time on a day (the 4-day board).
    -- start_min = minutes from midnight; duration_min = length of the slot.
  ...
  try { db.exec('ALTER TABLE plan_blocks ADD COLUMN start_min INTEGER NOT NULL DEFAULT 540'); } catch { /* already there / table new */ }
